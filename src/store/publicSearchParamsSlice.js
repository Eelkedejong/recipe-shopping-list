...
// Search params for public recipes are stored separately from the search params for the user's recipes.
const initialState = {
  typeOfMeal: [],
  typeOfDish: [],
  cuisine: [],
...
export const {
  ...
  updatePage,
  resetSearchParams,
} = publicSearchParamsSlice.actions;

export default publicSearchParamsSlice.reducer;
